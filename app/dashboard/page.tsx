    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg p-6 mb-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-2xl font-semibold font-['Inter']">Life Status</h2>
        ...
        {activeTab === 'beneficiaries' ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between h-10">
              <h2 className="text-2xl font-semibold font-['Inter'] leading-none">Notifications</h2>
              <div className="flex items-center gap-4">
                <div className="relative flex items-center">
                  <Search className="absolute left-2.5 top-1/2 h-4 w-4 text-muted-foreground -translate-y-1/2" />
                  <Input placeholder="Filter through your notifications" className="pl-8 font-['Inter']" />
                </div>
                <div className="flex gap-2">
                  <Button variant="outline" className="bg-white font-['Inter']">All</Button>
                  <Button variant="outline" className="bg-white font-['Inter']">Unread</Button>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start justify-between p-4 bg-white rounded-lg border border-gray-100">
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-gray-900 font-medium font-['Inter']">Confirmed</span>
                    <span className="text-sm text-gray-500 font-['Inter']">09 Jul 2023 21:05</span>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-500 font-['Inter']">1 month</span>
              ...
              <div className="flex items-start justify-between p-4 bg-white rounded-lg border border-gray-100">
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-gray-900 font-medium font-['Inter']">Confirm Activity</span>
                    <span className="text-sm text-gray-500 font-['Inter']">09 Jul 2023 21:05</span>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-500 font-['Inter']">4 months</span>
                  <Button variant="ghost" size="icon">
                    <MoreVertical className="h-4 w-4" />
                  </Button>
                </div>
